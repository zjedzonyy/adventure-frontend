        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="space-y-6">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Community</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Followers isExpanded={followersIsExpanded} setIsExpanded={setFollowersIsExpanded} />
              <Followings
